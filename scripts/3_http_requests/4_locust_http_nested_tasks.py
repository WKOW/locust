...
class UserBehaviour(TaskSet):
    ...
    class Agent_Lookup(SequentialTaskSet):
       ...
       @task(1)
       def stop(self):
        print("I am stopping agent search")
        self.interrupt()
